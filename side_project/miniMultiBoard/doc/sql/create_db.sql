...
CREATE TABLE users(
	...
	,updatee_at		TIMESTAMP				NOT NULL DEFAULT CURRENT_TIMESTAMP()
...
-- 3) boards_catagory(게시판 기본 정보) Table
--		- pk, 게시판타입, 게시판이름
...
-- FK 추가
ALTER TABLE boards ADD CONSTRAINT fk_boards_u_id 
FOREIGN KEY (u_id)
REFERENCES users(u_id);

ALTER TABLE boards ADD CONSTRAINT fk_boards_bc_type
FOREIGN KEY (bc_type)
